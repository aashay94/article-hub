...
describe('Component: MainComponent', function() {
    ...
    it('should attach a list of articles to the controller', () => {
        // `GET /api/articles` should be made once
        const req = httpTestingController.expectOne('/api/articles');
        ...
        expect(comp.awesomeArticles).to.equal(mockThings);
    });
});
